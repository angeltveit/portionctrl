...
function template(__INIT__) {
  ...
  if (starred) {
    ...
    if (!starred.length) {
      let e$6 = $$.create("i");
      $$.child(e$6, $$.text(`No ingredients starred`));
  ...
  if (list) {
    ...
    $$.each(list, item => {
      ...
      if (!this.isStarred(item)) {
        ...
        $$.events(e$11, this, [["click", e => this.star(item)]]);
        let e$12 = $$.create("kcal-icon");
        $$.attrs(e$12, {
          "name": "heart"
        });
        $$.child(e$11, $$.element(e$12));
...
(function(){
module.exports = "h1:first-of-type{margin-top:0}h1,h2{font-weight:300;margin:0;margin-top:1em;color:#00b4d8;text-align:center}.ingredients,.starred{max-height:150px;overflow:auto;margin:0 1em;background-color:rgba(0,0,0,0.1);border-radius:5px;padding:.5em;scroll-behavior:touch;}.ingredients .item,.starred .item{display:flex;margin:.5em 0;padding:.5em;background-color:rgba(0,0,0,0.1);}.ingredients .item a,.starred .item a{margin-left:auto;color:currentColor;text-decoration:none}";
}).apply(this, arguments);
